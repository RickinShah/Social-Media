			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" id="form" name="form" accept-charset=utf-8>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="otp" id="otp" placeholder="OTP">
                    ...
                    <input type="hidden" id="action" name="action" value="checkOtp" />
				</form>
			</div>
		</div>
	</div>
	...
	$("#submitbtn").click(function(event) {
		...
		$.ajax ({
			...
			success: function(response) {
				if(response.success) {
				    window.location.href = "/Social_Media/jsp/ChangePassword.jsp";
				}
				else {
					alert(response.msg);
